...
<head>
	...
	<title>Successful Vacancy Post | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Successful Vacancy Post</h1>
					</header><!-- .entry-header -->

					<div class="entry-content">

<?php
//line 97: Gets the system_token variable value from the URL
$system_token=$_GET["t"];

//lines 100-108: Informs the user about finishing successfully the upload job vacancy process and allows him to go back to the Post Vacancy page
echo "<p>The internship vacancy was successfully posted.</p>";
echo "<p>If you wish to view the vacancy click \"Available Vacancies\".</p>";
echo "<p>If you wish to upload a new internship vacancy click \"Post Vacancy\" below.</p><br/>";

echo "<table>";
		echo "<tr><button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/available_job_vacancies.php`;'>Available Vacancies</button> </tr>";
		echo "<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>";
		echo "<tr><button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/what_to_do.php?t=".$system_token ."`;'>Post Vacancy</button> </tr>";
echo "</table>";
