...
<head>
	...
	<title>Step 1: Personal Information | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Step 1: Personal Information</h1>
					</header><!-- .entry-header -->

					<div class="entry-content">

<?php 
//lines 97-101: Establish database connection
...
//lines 108-162: Gets the system_token variable value from the URL, selects data from DB and prints them in a form
require_once('wp-config.php');

$system_token= $_GET["t"];

$sql= "select * from wp_users where token= '". $system_token  ."'";
...
if ($result->num_rows ==1){
		...
		echo "<p>Please fill in the requested information below.</p><br/>";
			
			echo "<form action='update_entry.php?t=" .$system_token ."' method='post' name='employee_register'>";
				echo "<table class='table_forms'>";
					echo "<tr class='table_forms'>";
						echo "<th class='table_forms'>Name:</th>";
						echo "<th class='table_forms'><input id='name' value='$name' name='name' type='text' disabled/></th>";
					echo "</tr>";
					echo "<tr class='table_forms'>";
						echo "<th class='table_forms'>Surname:</th>";
						echo "<th class='table_forms'><input id='surname' value='$surname' name='surname' type='text' disabled/></th>";
					echo "</tr>";
					echo "<tr class='table_forms'>";
						echo "<th class='table_forms'>eIdentifier:</th>";
						echo "<th class='table_forms'><input id='surname' value='$eIdentifier' name='eIdentifier' type='text' disabled/></th>";
					echo "</tr>";
					echo "<tr class='table_forms'>";
						echo "<th class='table_forms'>Telephone Number:</th>";
						echo "<th class='table_forms'><input id='telephone_number' value='' name='telephone_number' type='tel' /></th>";
					echo "</tr>";
					echo "<tr class='table_forms'>";
						echo "<th class='table_forms'>Email:</th>";
						echo "<th class='table_forms'><input id='email' value='$user_email' name='user_email' type='email' /></th>";
					echo "</tr>";
					echo "<tr class='table_forms'>";
						echo "<th class='table_forms'>Country:</th>";
						echo "<th class='table_forms'><input id='email' value='$country' name='country' type='text' /></th>";
					echo "</tr>";
				echo "</table><br/><br/>";
				echo "<p>Thank you for providing your personal information. Please click \"Next\" to continue.</p><br/>";
				echo "<table>";
