...
<head>
	...
	<title>Process Failed | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Process Failed</h1>
					</header><!-- .entry-header -->
...
<?php
//linew 99-104: Inform the user about the failure of the process and allows him to go back to the Home page
echo "<p>You have not been authorized to continue. This is because either your authentication through STORK 2.0 was not successful, or the required attributes were not successfully retrieved, or the attributes did not have the appropriate values for providing your entitlement to apply for opening an account with us.</p>";
echo "<p>Please try again later or contact your national Identity Provider for further information.</p><br/>";

echo "<p>If you would like to try again, please click on the \"Go to Home page!\" button below.</p><br/><br/>";

echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/home.php`;'>Go to Home page!</button>";
