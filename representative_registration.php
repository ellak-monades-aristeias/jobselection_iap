...
<head>
	...
	<title>Step 3: Company&#8217s Representative Information | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Step 3: Company&#8217s Representative Information</h1>
					</header><!-- .entry-header -->
...
<?php
//line 98: Gets the variable emp_system_t value from the URL
$emp_system_t= $_GET["t"];

//lines 101-114: Creates a form with the needed basic representative information so to be submitted by the employee
echo "<p>Please fill in the requested information below.</p>";
			
			echo "<form action='representative_register.php?t=" .$emp_system_t ."' method='post' name='representative_register'>";
			echo "<table class='table_forms'> <tr class='table_forms'> <th class='table_forms'>First Name: </th> <th class='table_forms'><input id='name' name='name' type='text' /></th> </tr>";
			echo "<tr class='table_forms'> <th class='table_forms'>Last Name: </th> <th class='table_forms'><input id='surname' name='surname' type='text' /></th> </tr>";
			echo "<tr class='table_forms'> <th class='table_forms'>Telephone Number: </th> <th class='table_forms'><input id='telephone_number' name='telephone_number' type='tel' /></th> </tr>";
			echo "<tr class='table_forms'> <th class='table_forms'>Email: </th> <th class='table_forms'><input id='email' name='email' type='email' /></th> </tr>";
			echo "</table><br/><br/>";
			echo "<p>Thank you for providing the company's representative information. Please click \"Next\" to continue.</p><br/>";
			echo "<table>";
