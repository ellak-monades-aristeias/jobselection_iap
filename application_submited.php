...
<head>
	...
	<title>Application Submited | Job Selection</title>
	...
	<![endif]-->
	<link rel="alternate" type="application/rss+xml" title="Test Job Selection &raquo; Feed" href="http://stork-ap.aegean.gr/JobSelection/?feed=rss2" />
<link rel="alternate" type="application/rss+xml" title="Test Job Selection &raquo; Comments Feed" href="http://stork-ap.aegean.gr/JobSelection/?feed=comments-rss2" />
<link rel="alternate" type="application/rss+xml" title="Test Job Selection &raquo; Employee&#8217;s Registration Comments Feed" href="http://stork-ap.aegean.gr/JobSelection/?feed=rss2&#038;page_id=4" />
...
<body class="page page-id-4 page-template-default logged-in admin-bar no-customize-support single-author">
	<div id="page" class="hfeed site">
		<header id="masthead" class="site-header" role="banner">
			<a class="home-link" href="http://stork-ap.aegean.gr/JobSelection/home.php" title="Test Job Selection" rel="home">
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Application Submited</h1>
					</header><!-- .entry-header -->

					<div class="entry-content">

<?php
//lines 98-110: Inform the user-student about the successful submition of his application
echo "<p>Your application has been successfuly submited.</p>";

echo "<p>If you wish to apply for an other internship vacancy click \"Available Vacancies\".</p><br/><br/>";

echo "<table>";
    echo "<tr>";
		echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/available_job_vacancies.php`;'>Available Vacancies</button>";
	echo "</tr>";
    echo "<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>";
    echo "<tr>";
		echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/home.php`;'>Home page</button>";
	echo "</tr>";
echo "</table>";
