...
<head>
	...
	<title>Internship Application Platform | Job Selection</title>
...
//lines 99-102: Inform the user about the actions "Register" and "Log-in"
echo "<p>Welcome to the centralized online service which interconnects companies that provide internship positions with all academic institutions in Greece by creating a unique internship positions vacancies database.</p>";
echo "<p>If you are a company wishing to publish internship vacancies and receive applications, please click \"Register\" to register in the platform.<p/>";
echo "<p>If you have already register, please click \"Log-in\" to publish vacancies.</p>";
echo "<br/>";

//lines 105-120: Creates the buttons "Register" and "Log-in"
echo "<table>";
	echo "<tr>";
			echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "</tr>";
	echo "<tr>";
		echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/how_to_login.php`;'>Log-in</button>";
	echo "</tr>";
	echo "<tr>";
			echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "</tr>";
	echo "<tr>";
		echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/how_to_register.php`;'>Register</button>";
	echo "</tr>";
echo "</table>";
echo "<br/>";
echo "<br/>";

//lines 123-132: Informs the user "student" about viewing the available internship job vacancies and creates the appropriate button "Internship Vacancies"
echo "<p>If you are a student wishing to view available internship job vacancies and apply, please click \"Internship Vacancies\" below.</p>";
echo "<br/>";
echo "<table>";
	echo "<tr>";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "</tr>";
	echo "<tr>";
		echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/available_job_vacancies.php`;'>Internship Vacancies</button>";
	echo "</tr>";
echo "</table>";
