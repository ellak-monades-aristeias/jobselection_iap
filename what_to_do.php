...
<head>
	...
	<title>Upload Internship Vacancy | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Upload Internship Vacancy</h1>
					</header><!-- .entry-header -->
...
//lines 100-111: Informs the user about the actions he can do and provides the appropriate buttons
echo "<p>To upload an internship vacancy please click \"Post Vacancy\" below. <p/>";
echo "<table>";
	echo "<tr>";
		echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/post_job_vacancy.php?t=".$system_token ."`;'>Post Vacancy</button>";
	echo "</tr>";
	echo "<tr>";
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "</tr>";
