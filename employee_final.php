...
<head>
	...
	<title>Notify Representative | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Notify Representative</h1>
					</header><!-- .entry-header -->
...
<?php
//line 98: Gets the emp_system_t value from the URL
$emp_system_t= $_GET["t"];

//lines 101-108: Informs the user-employee about sending an email notification to the representative by clicking the Send button
echo "<p>Your information was successfully stored. A notification email will be automatically send to the representative in order to finalize the registration.</p>";
echo "<p>Please click \"Send\" button to notify the representative.</p><br/>";

echo "<form action='send_email.php?t=" .$emp_system_t ."' method='post' name='send_email'> <table>";
