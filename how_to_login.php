...
<head>
	...
	<title>How to login | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">How to login</h1>
					</header><!-- .entry-header -->

					<div class="entry-content">

<?php 
//lines 97-113: Informs the user about the login steps needed to upload a job vacancy
echo "<p>To log in via STORK 2.0 please click \"Log In\" below.</p>";

echo "<p>To log in and upload a vacancy you first need to register the company.</p>";
echo "<p>If the company has not been registered, please click \"Home page\" and follow the instructions to register.</p><br/><br/>";

echo "<form action='login.php' method='post' name='how_to_login'>";
    echo "<table>";
        echo "<tr>";
...
$con = mysqli_connect("localhost","TestJobSelection","fcD6EGaTQsp6LXC9","Test_Job_Selection"); 
...
$token_role="login";
$sql="INSERT INTO `Test_Job_Selection`.`tokens` (`SS_token`, `token_role`, `system_token`)
