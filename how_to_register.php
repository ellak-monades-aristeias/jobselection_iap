...
<head>
	...
	<title>How to register | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Internship Application Platform</h1>
					</header><!-- .entry-header -->
...
<?php 
//lines 98-102: establish database connection
...
//lines 105-124: Informs the user about the registration steps
echo "<p>Thank you for your interest in the Internship Application Platform. If you want to continue with your registration using the STORK 2.0 service, please read the instructions below and then click on the \"Next\" button.</p>";

echo "<b>Registration Steps:</b><br/><br/>";

echo "<p>For the registration, you will be asked to authenticate via STORK 2.0, validate the information and fill in two forms with information about the company.</p>";

echo "<strong>Step 1:</strong> Personal Information<br/><br/>";

echo "<p>After clicking \"Next\" button, you will be redirected to STORK 2.0 framework  in order to authenticate. Subsequently, you will have to validate the information and also provide your contact details.</p>";

echo "<strong>Step 2:</strong> Company Information<br/><br/>";

echo "<p>Continue with providing the company's information. After submitting the form you will be redirected to the final step.</p>";

echo "<strong>Step 3:</strong> Company's Representative Information<br/><br/>";

echo "<p>Please fill in the company's representative form. After submitting, a notification email will be automatically send to the representative's email and inform him with the actions he has to take in order to finalize the registration.</p>";
echo "<br/><br/>";
echo "<p>Please click \"Next\" to authenticate via STORK 2.0 and initiate the process.</p>";
echo "<br/>";

//lines 127-138: Created the buttons "Next" and "Cancel"
echo "<form action='register.php' method='post' name='how_to_register'>";
    ...
    echo "<table>";
        ...
        echo "<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>";
        echo "<tr>";
			echo "<button type='button' onclick='location.href = `http://stork-ap.aegean.gr/JobSelection/cancel_form.php`;'>Cancel</button>";
		echo "</tr>";
	echo "</table>";
echo "</form>";
...
$sql1="INSERT INTO `Test_Job_Selection`.`tokens` (`SS_token`, `token_role`, `system_token`)
...
$sql2="INSERT INTO `Test_Job_Selection`.`wp_users` (`user_login`, `user_pass`, `user_nicename`, `user_email`, `display_name`,
