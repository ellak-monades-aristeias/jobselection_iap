...
<head>
	...
	<title>Vacancy Application | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Vacancy Application</h1>
					</header><!-- .entry-header -->
...
//line 105: Get the user's system token from the info_retrieve.php passed by the URL
$student_token= $_GET["t"];

//lines 108-114: Get the job id matched with the student_token value
...
//lines 117-124: Get the job title matched with the job_id value
require_once('wp-config.php');
$sql2 = "SELECT title FROM job_vacancies WHERE job_id='". $job_id ."'";
...
//lines 127-209: Selects and prints the retrieved information for the student's application. Asks some extra information to be submited	
echo "<h3><u>Application for \" " .$job_title ." \" Internship</u></h3>";
echo "<p>Please find below the application details, fill in your Contact Information and click \"Submit\" to finalize your application.</p>";

//collect the student details from database
require_once('wp-config.php');
...
echo "<table>";
	echo "<tr>";
		echo "<th><u>First Name:</u> " .$givenName ."</th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th><u>Last Name:</u> " .$surname ."</th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th><u>eIdentifier:</u> " .$eIdentifier ."</th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th><u>Student:</u> </th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th>Institution: " .$nameOfInstitution_isStudent ."</th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th>Field Of Study: " .$study_isStudent ."</th>"; 
	echo "</tr>";
	
if ($level!="" || $yearObtained="" || $nameOfInstitution_hasDegree!=""){	
	echo "<tr>";
		echo "<th><u>Degree:</u> </th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th>Level: ". $level ."</th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th>Year Obtained: ". $yearObtained ."</th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th>Institution: " .$nameOfInstitution_hasDegree ."</th>";
	echo "</tr>";
}
echo "</table>";
		
//create the form button which after clicking will call send_app.php to send the notification mail to the company and the student.
// onclick send the user's systen token
echo "<br/><br/>";
echo "<p>Please fill in your contact information below:</p>";
echo "<form action='send_app.php?t=" .$student_token ."' method='post' name='send_app'>";
echo "<table>";
	echo "<h3>Contact Information:</h3>";
	echo "<tr>";
		echo "<th class='table_forms'>Email:</th>";
		echo "<th class='table_forms'><input id='email' value='' name='student_email' type='email' /></th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th class='table_forms'>Telephone Number:</th>";
		echo "<th class='table_forms'><input id='telephone_number' value='' name='student_tel' type='tel' /></th>";
	echo "</tr>";
echo "</table><br/><br/>";

echo "<p>Please click \"Submit\" to send your application.</p><br/>";
