...
<head>
	...
	<title>Registration Completed | Job Selection</title>
		...
		<div id="content" class="site-content" role="main">
				...
				<article id="post-4" class="post-4 page type-page status-publish hentry">
					<header class="entry-header">
						...
						<h1 class="entry-title">Registration Completed</h1>
					</header><!-- .entry-header -->
...
<?php
//lines 98-104: Informs the user about finishing the registration process and allows him to go back to the Home page 
echo "<p>The company's registration in the Internship Application Platform has been completed.<p>";

echo "<p>Thank you for your registration!</p><br/><br/>";

echo "<p>If you wish to upload an internship vacancy, please click \"Home page\" below.</p><br/><br/>";
